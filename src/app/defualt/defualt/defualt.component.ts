import { Component, OnInit, HostBinding, OnChanges, Input, ViewEncapsulation } from '@angular/core';
...
export class defaultComponent implements OnInit /// ,OnChanges
 {
  ...
  ngOnInit() {
      ...
      this.images.push({source:'assets/bg-14.jpg', alt:'this is nice man  this is nice man  this is nice man this is nice man  ', title:'this is my title'});
